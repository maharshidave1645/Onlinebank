...
<p>&nbsp;</p>	</td>
	...
	<table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <th colspan="3" bgcolor="#333333" scope="col"><font color="#FFFFFF">Customers  Details  Of The Bank</font></th>
        </tr>
        <tr>
          <td width="39%">&nbsp;</td>
          <td width="3%">&nbsp;</td>
        ...
        <% 
            ...
            <tr>
             ...
             <th colspan="3" scope="col"><font>Username</font></th>
             <th colspan="3" scope="col"></th><th colspan="3" scope="col"></th>
             <th colspan="3" scope="col"><font>Address</font></th>
             <th colspan="3" scope="col"></th><th colspan="3" scope="col"></th>
             <th colspan="3" scope="col"><font>E-mail</font></th>
             <th colspan="3" scope="col"></th><th colspan="3" scope="col"></th>
             <th colspan="3" scope="col"><font>Mobile Number</font></th>
             </tr>
        ...
        <%
             ...
             <td colspan="3" scope="col" align="center"></td><td colspan="3" scope="col"></td>
             <td colspan="3" scope="col" align="center"><font> <%  out.println(rs.getString(6));  %></font></td>
             <td colspan="3" scope="col"></td><td colspan="3" scope="col"></td>
              <td colspan="3" scope="col" align="center"><font> <%  out.println(rs.getString(7));  %></font></td>
            <%
