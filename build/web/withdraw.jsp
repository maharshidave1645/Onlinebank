...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<form id="form1" name="form1" method="post" action="cusWithdraw.jsp">
	  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="Amount" type="text" id="Amount" size="10" pattern="[1-9]{1,9}"  required/>  
            Rs.</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><label>
            <input name="Submit" type="submit" onclick="MM_validateForm('Amount','','RisNum');return document.MM_returnValue" value="Withdraw Amount" />
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
