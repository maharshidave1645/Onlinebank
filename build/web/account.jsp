	...
	<form id="form1" name="form1" method="post" action="doAccount.jsp">
	  <table width="70%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td>:</td>
          <td><label>
                 <input name="uname" type="text" id="uname"  readonly="true" value="<%= (String)session.getAttribute("cust_name")%>" required/>
          </label></td>
        </tr>
        <tr>
          ...
          <td>:</td>
          <td><label>
            <input name="accno" type="text" id="accno"  readonly="true" value="<%=accNo%>" required/>
          </label></td>
        </tr>
        <tr>
